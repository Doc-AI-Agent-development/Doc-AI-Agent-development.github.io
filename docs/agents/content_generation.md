...
구성안을 작성해 관리자 승인을 거친 뒤 발표 자료를 생성합니다. 구성안에는 시험·설문 계획이 포함되며, [시험 문제 에이전트](./exam_generation.md)가 같은 구성안으로 문항을 생성합니다. 모든 섹션과 문항은 교육 자료의 근거에 연결됩니다.
...
* [시험 문제 에이전트](./exam_generation.md) — 같은 구성안으로 시험·설문 생성
