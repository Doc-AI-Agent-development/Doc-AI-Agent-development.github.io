...
생성되는 교육 내용의 모듈 개수·분량·눈높이·예시 형태입니다.
...
첫 생성·부분 생성·재작성 호출이 몰릴 때의 조절 값입니다.
...
시간이 빈 교육을 언제 되묻는지입니다. 공란으로 두기로 한 답은 다시 묻지 않습니다.
...
회차·교육을 늘렸을 때 기존 내용은 보존하고 새 부분만 만듭니다.
