...
교육계획 원본(해당 회차의 교육내용)과 교육과정 정보, 법령 근거를 조회합니다. **구성
...
달라졌는지 언제든 대조할 수 있습니다. 즉석 주제나 첨부 문서 기반으로 시작하는 경우에는
그에 해당하는 재료가 대신 준비됩니다.
...
**소비.** 확정된 구성 계획은 근거 수집(교시별 주제를 검색 질의 재료로), 생성(설정과 교시
