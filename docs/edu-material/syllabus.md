...
법령 근거를 조회합니다. 조회된 연간계획 원문은 별도로 보관되며 **이후 어떤 수정에도
변하지 않습니다** — 담당자의 수정은 구성 계획에만 쌓이므로, 원래 계획에서 무엇이
달라졌는지 언제든 원본과 대조할 수 있습니다. 즉석 주제나 첨부 문서 기반으로 시작하는
경우에는 그에 해당하는 재료가 대신 준비됩니다.
