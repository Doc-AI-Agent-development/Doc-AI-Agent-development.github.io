...
단계는 **수집된 근거만으로** 내용을 구성합니다. 관련 사내 문서를 찾지 못하면 그 사실을 담당자에게 안내하고 연간 교육계획·법령
근거만으로 진행하며, 계획 서술조차 없어 근거가 전무하면 **생성하지 않고 그 사실을
안내합니다**.
...
첨부 근거는 수정 전후 교시의 대응 관계([구성 계획](./syllabus.md)의 출처 교시 기록)를 따라
